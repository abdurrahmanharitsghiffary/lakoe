...
export type AlertAction =
  ...
  | {
      ...
      title: string;
      body?: string;
      actionProps?: Omit<ButtonProps, "type">;
      cancelProps?: Omit<ButtonProps, "onClick" | "type">;
      cancelButton?: string;
      actionButton?: string;
    }
  | {
      ...
      >
        <AlertDialogContent asChild>
          ...
          >
            ...
            <AlertDialogFooter>
              <Button type="button" onClick={close} {...state?.cancelProps}>
                {state.cancelButton}
              </Button>
              {state.type === "alert" ? null : (
                <Button type="submit" {...state?.actionProps}>
                  {state.actionButton}
                </Button>
              )}
            </AlertDialogFooter>
