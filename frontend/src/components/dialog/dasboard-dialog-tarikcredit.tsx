...
import { useWithdrawalCredit } from "@/features/hook/use-withdrawal-credit";
...
export default function DashboardDialogTarikCredit({
    isOpen,
    onOpen,
              ...
              <DialogHeader>
                ...
                <DialogDescription className="flex w-100">
                    <Card className=" bg-gray w-full h-auto py-4 mx-3 mt-3 justify-start">
                      ...
                      <div className="flex px-3 gap-3 mx-3 ">
                        <p> • </p>
                        <p>Dan akan diproses dihari kerja pada jam 09:00 - 17:00
                        </p>
                      </div>
                      <div className="flex px-3 gap-3 mx-3 ">
                        <p> • </p>
                        <p>Direkomendasikan Withdraw ke Rekening BCA, Selain rekening BCA akan  memakan waktu 2-3 hari kerja</p>
                      </div>
                    </Card>
                </DialogDescription>
              </DialogHeader >
                ...
                <FormField
                    ...
                    <>
                        ...
                        <FormDescription className="flex mx-3 gap-2">
                           <p className="text-blue-500 italic">Jumlah Maksimal: </p>
