        ...
        <div className="flex flex-col w-full gap-4 p-[20px] mb-[-22px]">
            <div>
                ...
                <Card className="flex flex-col bg-white h-auto gap-4 py-4 w-full">
                       <p className="mx-4">Current Balance</p>
                        <h1 className="text-[26px] font-bold mx-4" style={{color:"#0086b3"}}>Rp0 </h1>
                        <Button onClick={()=>setIsWithdrawalOpen(true)} className=" mx-4 w-100 bg-lakoe-primary">
                            Tarik Credit
                        </Button>
            ...
            <div className="flex flex-row gap-4">
                ...
                <Card className="flex flex-col bg-white h-auto gap-4 py-4 w-full">
                       ...
                       <span className="mx-4 flex flex-row">Saldo Tertahan <PiExclamationMarkFill className="mx-1 h-5 w-5 mt-1"/> </span>
                       <span className="mx-4" style={{color:"blue"}}>Lihat Semua</span>
