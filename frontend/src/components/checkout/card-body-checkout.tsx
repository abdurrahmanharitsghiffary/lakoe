          ...
          <div className="flex  w-full">
                ...
                {errors.telephone && 
                  ...
                  <div className="flex-col px-3 mb-4">
                        <>
                          <Label htmlFor="subDistrict" className="text-lg px-1 mb-[-10px]">Kecamatan</Label>
                              <Select>
                                <SelectTrigger className="text-lg h-12">
                                  <SelectValue  {...register('subDistrict')} id="subDistrict" placeholder="Pilih Kecamatan" />
                                </SelectTrigger>
                                <SelectContent>
                  ...
                  <div className="flex-col px-3 mb-4">
                        <>
                          <Label  htmlFor="ward" className="text-lg px-1 mb-[-10px]">Kelurahan</Label>
                              <Select>
                                <SelectTrigger className="text-lg h-12">
                                  <SelectValue id="ward"placeholder="Pilih Kelurahan" {...register('ward')} />
                                </SelectTrigger>
                                <SelectContent>
                  ...
                  <div className="flex-col px-3 mb-4">
                        <>
                          <Label className="text-lg px-1 mb-[-10px]">Detail Alamat</Label>
                              <Textarea 
                                id="addressDetails"
