            ...
            >
                ...
                >
                    <div className="flex flex-col w-full items-start gap-3">
                        ...
                        <p className="font-bold text-[20px] data-[state=active]:text-black-0">Info Pengiriman</p>
                ...
                >
                    <div className="flex flex-col w-full items-start gap-3 ">
                        ...
                        <p className="font-bold text-[20px] data-[state=active]:text-black-0">Metode Pembayaran</p>
                    </div>
                </TabsTrigger>
                </TabsList>
