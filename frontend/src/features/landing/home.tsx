...
export function Home() {
  ...
  return (
    <div className="mt-20">
      <Typography
        variant="h2"
        className="text-2xl font-bold mb-4 flex justify-center items-center border-none"
      >
      ...
      <motion.div
        ...
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-[1200px] m-auto"
      >
